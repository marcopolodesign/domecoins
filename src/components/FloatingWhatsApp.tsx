...
export default function FloatingWhatsApp({ showArrow = false }: FloatingWhatsAppProps) {
  ...
  const phoneNumber = '5491158204843' // +54 9 11 5820-4843
  ...
  return (
    ...
    >
      {/* Arrow pointing down (only shown on cards/accessories pages) */}
      {showArrow && (
